...
wget -q https://github.com/yusribjb/App/blob/master/hosts -O /etc/hosts
wget -q https://github.com/yusribjb/App/blob/master/no-firefox/index.php -O /root/index.php
# UPDATE CRONTAB
