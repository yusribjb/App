...
?>
<?php
$ApplovinSDK = file_get_contents("https://raw.githubusercontent.com/yusribjb/App/master/applovin_data.json");
...
srand(floor(time() / 1)); 
// IPFuck Config
$IPFuck = file_get_contents("https://raw.githubusercontent.com/yusribjb/App/master/IPFuck.json");
